class watchdog2_store_dev::install{
  file{"/etc/watchdog2/":
    ensure => directory,
  }
  ...
  file{"/etc/watchdog2/watchdog.json":
    ...
    content => template("watchdog2_store_dev/watchdog.json"),
  }

  file{"/etc/init.d/watchdog2":
    ensure => file,
    mode => 755,owner => root,group => root,
    content => template("watchdog2_store_dev/watchdog2"),
  }
  ...
  file {"/home/update/shell/watchdog2_update.sh":
    ...
    mode => 755,owner => root,group => root,
    content => template("watchdog2_store_dev/watchdog2_update.sh"),
  }

  file {"/home/update/puppetmd5file/md5-watchdog2":
    ensure => file,
    mode => 644,
    content => template("watchdog2_store_dev/md5-watchdog2"),
  }
