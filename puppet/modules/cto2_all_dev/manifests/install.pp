class cto2_all_dev::install {
  file {"/home/update/shell/ctod_update.sh":
    ensure => file,
    mode => 755,owner => root,group => root,
    content => template("cto2_all_dev/ctod_update.sh"),
  }

  file {"/home/update/shell/libstdc_update.sh":
    ensure => file,
    mode => 755,owner => root,group => root,
    content => template("cto2_all_dev/libstdc_update.sh"),
  }

  file {"/home/update/puppetmd5file/md5-ctod":
    ensure => file,
    mode => 644,
    content => template("cto2_all_dev/md5-ctod"),
  }

  file {"/home/update/puppetmd5file/md5-libstdc":
    ensure => file,
    mode => 644,
    content => template("cto2_all_dev/md5-libstdc"),
  }
