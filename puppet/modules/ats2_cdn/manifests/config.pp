...
class ats2_cdn::config {
   ...
   file{"/etc/trafficserver/cache.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/cache.config"),
   }
   ...
   file{"/etc/trafficserver/cluster.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/cluster.config"),
   }
   ...
   file{"/etc/trafficserver/congestion.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/congestion.config"),
   }
   ...
   file{"/etc/trafficserver/hosting.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/hosting.config"),
   }
   ...
   file{"/etc/trafficserver/icp.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/icp.config"),
   }
   ...
   file{"/etc/trafficserver/ip_allow.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/ip_allow.config"),
   }
   ...
   file{"/etc/trafficserver/log_hosts.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/log_hosts.config"),
   }
   ...
   file{"/etc/trafficserver/logs_xml.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/logs_xml.config"),
   }
   ...
   file{"/etc/trafficserver/parent.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/parent.config"),
   }
   ...
   file{"/etc/trafficserver/plugin.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/plugin.config"),
   }
   ...
   file{"/etc/trafficserver/prefetch.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/prefetch.config"),
   }
   ...
   file{"/etc/trafficserver/proxy.pac":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/proxy.pac"),
   }

#   file{"/etc/trafficserver/records.config_tmp":
#      ensure  =>  file,
#      mode    =>  600,
#      content => template("ats2_cdn/records.config"),
...
#      ensure  =>  file,
#      mode    =>  755,
#      content => template("ats2_cdn/records.config.sh"),
#   }
   ...
   file{"/etc/trafficserver/remap.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/remap.config"),
   }
   ...
   file{"/etc/trafficserver/socks.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/socks.config"),
   }
   ...
   file{"/etc/trafficserver/splitdns.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/splitdns.config"),
   }
   ...
   file{"/etc/trafficserver/ssl_multicert.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/ssl_multicert.config"),
   }
   ...
   file{"/etc/trafficserver/stats.config.xml":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/stats.config.xml"),
   }
   ...
   file{"/etc/trafficserver/trafficserver-release":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/trafficserver-release"),
   }
   ...
   file{"/etc/trafficserver/update.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/update.config"),
   }
   ...
   file{"/etc/trafficserver/vaddrs.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/vaddrs.config"),
   }
   ...
   file{"/etc/trafficserver/volume.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/volume.config"),
   }
   ...
   file{"/etc/trafficserver/plugin/background_fetch.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/background_fetch.config"),
   }

#   file{"/usr/lib64/trafficserver/plugins/add_header_hit.so":
#      ensure  =>  file,
#      mode    =>  755,
#      content => template("ats2_cdn/add_header_hit.so"),
#   }
   ...
   file{"/etc/trafficserver/plugin/cacheurl.config":
      ...
      owner   =>  'ats',
      group   =>  'ats',
      content => template("ats2_cdn/cacheurl.config"),
   }
