...
if res_tab["snapshotImgWidth"] then
    ngx.var.rtmp_port = ngx.var.rtmp_port .. "&snapshotImgWidth=" .. res_tab["snapshotImgWidth"]
end

if res_tab["snapshotImgHeight"] then
    ngx.var.rtmp_port = ngx.var.rtmp_port .. "&snapshotImgHeight=" .. res_tab["snapshotImgHeight"]
end
