...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/cache.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/cluster.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/congestion.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/hosting.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/icp.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/ip_allow.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/log_hosts.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/logs_xml.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/parent.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/plugin.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/prefetch.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/proxy.pac"),
#   }
#
#   file{"/etc/trafficserver/records.config_tmp":
#      ensure  =>  file,
#      mode    =>  600,
#      content => template("ats5_cdn_dev/records.config"),
...
#      ensure  =>  file,
#      mode    =>  755,
#      content => template("ats5_cdn_dev/records.config.sh"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/remap.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/socks.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/splitdns.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/ssl_multicert.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/stats.config.xml"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/update.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/vaddrs.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/volume.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/background_fetch.config"),
#   }

#   file{"/usr/lib64/trafficserver/plugins/add_header_hit.so":
#      ensure  =>  file,
#      mode    =>  755,
#      content => template("ats5_cdn_dev/add_header_hit.so"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats5_cdn_dev/cacheurl.config"),
#   }
