class ats_cdn_sta::install {

#  file { "/home/update/shell/ats_update.sh":
#    ensure => file,
#    mode => 755,owner => root,group => root,
#    content => template("ats_cdn_sta/ats_update.sh"),
#
#  }
#  file { "/home/update/puppetmd5file/md5-ats":
#    ensure => file,
#    mode => 644,
#    content => template("ats_cdn_sta/md5-ats"),
#  }
  package { "tcl":
    ensure => "8.5.7-6.el6",
  ...
  package { "trafficserver":
    ...
    before => Class["ats_cdn_sta::config"],
    require => Class["systembase_cdn_sta"],
