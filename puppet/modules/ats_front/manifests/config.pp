...
#      ensure  =>  file,
#      mode    =>  755,
#      content => template("ats_front/add_header_hit.so"),
#   }
#
#   file{"/usr/local/etc/ats/plugin.config":
#      ensure  =>  file,
#      mode    =>  644,
#      content => template("ats_front/plugin.config"),
#   }
#
#   file{"/usr/local/etc/ats/remap.config":
#      ensure  =>  file,
#      mode    =>  644,
#      content => template("ats_front/remap.config"),
#   }
#
   file{"/usr/local/etc/ats/plugin/cacheurl.config":
      ensure  =>  file,
      mode    =>  644,
      content => template("ats_front/cacheurl.config"),
   }
#
