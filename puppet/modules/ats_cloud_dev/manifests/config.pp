...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/cache.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/cluster.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/congestion.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/hosting.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/icp.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/ip_allow.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/log_hosts.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/logs_xml.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/parent.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/prefetch.config"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/proxy.pac"),
#   }
#
#   file{"/etc/trafficserver/records.config_tmp":
#      ensure  =>  file,
#      mode    =>  600,
#      content => template("ats_cloud_dev/records.config"),
...
#      ensure  =>  file,
#      mode    =>  755,
#      content => template("ats_cloud_dev/records.config.sh"),
#   }
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/socks.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/splitdns.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/ssl_multicert.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/stats.config.xml"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/update.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/vaddrs.config"),
#   }
#
...
#      owner   =>  'ats',
#      group   =>  'ats',
#      content => template("ats_cloud_dev/volume.config"),
#   }
