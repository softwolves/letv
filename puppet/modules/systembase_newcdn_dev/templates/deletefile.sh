...
##### deletc /letv core-
find /letv/ -maxdepth 1  -name "core-*" -cmin +480 |xargs -i rm -rf {}
find /letv/fet/core/ -maxdepth 1  -name "core-*" -cmin +480 |xargs -i rm -rf {}
#####delete nginx core
...
#####NEWCDN ATS LOG
find /var/log/trafficserver/  -type f -name "ats_letv_access.log_*" -ctime +7 |xargs -i rm -f {}
find /var/log/trafficserver/  -type f -name "error.log_*" -ctime +7 |xargs -i rm -f {}
find /var/log/trafficserver/realstat/  -type f -ctime +7 |xargs -i rm -f {}
