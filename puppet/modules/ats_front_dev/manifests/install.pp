class ats_front_dev::install {
  ...
  file { "/lib/libtcl8.5.so":
    ...
    source => "puppet://$fileserver/ats_front_dev/libtcl8.5.so"
  ...
  file { "/home/update/shell/ats_update.sh":
    ...
    mode => 755,owner => root,group => root,
    content => template("ats_front_dev/ats_update.sh"),

  }
  file { "/home/update/puppetmd5file/md5-ats":
    ensure => file,
    mode => 644,
    content => template("ats_front_dev/md5-ats"),
  }
