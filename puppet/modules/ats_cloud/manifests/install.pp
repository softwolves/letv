class ats_cloud::install {

#  file { "/home/update/shell/ats_update.sh":
#    ensure => file,
#    mode => 755,owner => root,group => root,
#    content => template("ats_cloud/ats_update.sh"),
#
#  }
#  file { "/home/update/puppetmd5file/md5-ats":
#    ensure => file,
#    mode => 644,
#    content => template("ats_cloud/md5-ats"),
#  }
  package { "tcl":
    ensure => "8.5.7-6.el6",
  ...
  package { "trafficserver":
    ...
    before => Class["ats_cloud::config"],
    require => Class["systembase_cloud"],
