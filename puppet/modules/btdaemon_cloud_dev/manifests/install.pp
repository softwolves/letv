class btdaemon_cloud_dev::install{

  file {"/home/update/shell/btdaemon_update.sh":
    ensure => file,
    mode => 755,owner => root,group => root,
    content => template("btdaemon_cloud_dev/btdaemon_update.sh"),
  }

#  file {"/home/update/shell/diamond_update.sh":
#    ensure => file,
#    mode => 755,owner => root,group => root,
#    content => template("btdaemon_cloud_dev/diamond_update.sh"),
#  }

  file {"/home/update/puppetmd5file/md5-btdaemon":
    ensure => file,
    mode => 644,
    content => template("btdaemon_cloud_dev/md5-btdaemon"),
  }

  file {"/home/update/puppetmd5file/md5-diamond":
    ensure => file,
    mode => 644,
    content => template("btdaemon_cloud_dev/md5-diamond"),
  }
...
#    ensure  => file,
#    mode    => 644,
#    content => template("btdaemon_cloud_dev/diamond.conf"),
#    require => File["/home/update/shell/diamond_update.sh"],
#  }
}
