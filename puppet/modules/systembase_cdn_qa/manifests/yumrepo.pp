class systembase_cdn_qa::yumrepo{
  file{"/etc/yum.repos.d/letv-pkgs.repo":
    ensure => file,
    mode => 644,
    content => template("systembase_cdn_qa/letv-pkgs.repo"),
  }

  file{"/etc/yum.repos.d/CentOS-Base.repo":
    ensure => file,
    mode => 644,owner => root,group => root,
    content => template("systembase_cdn_qa/CentOS-Base.repo"),
  }

  file{"/etc/yum.repos.d/CentOS-Debuginfo.repo":
    ensure => file,
    mode => 644,owner => root,group => root,
    content => template("systembase_cdn_qa/CentOS-Debuginfo.repo"),
  }

  file{"/etc/yum.repos.d/CentOS-Media.repo":
    ensure => file,
    mode => 644,owner => root,group => root,
    content => template("systembase_cdn_qa/CentOS-Media.repo"),
  }

  file{"/etc/yum.repos.d/CentOS-Vault.repo":
    ensure => file,
    mode => 644,owner => root,group => root,
    content => template("systembase_cdn_qa/CentOS-Vault.repo"),
  }
